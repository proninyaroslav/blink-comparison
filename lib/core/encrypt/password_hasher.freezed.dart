...
mixin _$SodiumHashInfo implements DiagnosticableTreeMixin {
 ...
 SecureKey get password; Uint8List get salt;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('password', password))..add(DiagnosticsProperty('salt', salt));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SodiumHashInfo&&(identical(other.password, password) || other.password == password)&&const DeepCollectionEquality().equals(other.salt, salt));
}


@override
int get hashCode => Object.hash(runtimeType,password,const DeepCollectionEquality().hash(salt));
...
@useResult
$Res call({
 SecureKey password, Uint8List salt
});
...
/// Create a copy of _SodiumHashInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? password = null,Object? salt = null,}) {
...
class _SodiumHashInfoData with DiagnosticableTreeMixin implements _SodiumHashInfo {
  const _SodiumHashInfoData({required this.password, required this.salt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SodiumHashInfoData&&(identical(other.password, password) || other.password == password)&&const DeepCollectionEquality().equals(other.salt, salt));
}
...
/// Create a copy of _SodiumHashInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? password = null,Object? salt = null,}) {
