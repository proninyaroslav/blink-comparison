...
import 'package:sembast/sembast.dart' as _i32;
import 'package:shared_preferences/shared_preferences.dart' as _i21;

import 'core/crash_report/crash_report_builder.dart' as _i30;
import 'core/crash_report/crash_report_id_generator.dart' as _i5;
import 'core/crash_report/crash_report_manager.dart' as _i42;
import 'core/crash_report/crash_report_sender.dart' as _i31;
...
import 'ui/app_cubit.dart' as _i38;
...
import 'ui/comparison/comparison.dart' as _i41;
import 'ui/comparison/comparison_settings_cubit.dart' as _i29;
import 'ui/cubit/error_report_cubit.dart' as _i43;
import 'ui/cubit/showcase_cubit.dart' as _i37;
...
import 'ui/preview/ref_image_options_cubit.dart' as _i35;
import 'ui/settings/page/appearance_cubit.dart' as _i40;
import 'ui/settings/page/camera_cubit.dart' as _i28;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i28.CameraSettingsCubit>(
      () => _i28.CameraSettingsCubit(get<_i26.AppSettings>()));
  gh.factory<_i29.ComparisonSettingsCubit>(
      () => _i29.ComparisonSettingsCubit(get<_i26.AppSettings>()));
  gh.factory<_i30.CrashReportBuilder>(
      () => _i30.ProdCrashReportBuilder(
          get<_i12.PlatformInfo>(), get<_i5.CrashReportIdGenerator>()),
      registerFor: {_prod});
  gh.factory<_i30.CrashReportBuilder>(
      () => _i30.DevCrashReportBuilder(
          get<_i12.PlatformInfo>(), get<_i5.CrashReportIdGenerator>()),
      registerFor: {_dev});
  gh.factory<_i30.CrashReportBuilder>(
      () => _i30.TestCrashReportBuilder(
          get<_i12.PlatformInfo>(), get<_i5.CrashReportIdGenerator>()),
      registerFor: {_test});
  gh.factory<_i31.CrashReportSender>(
      () => _i31.CrashReportSenderImpl(get<_i12.PlatformInfo>()));
  await gh.singletonAsync<_i32.Database>(
      () => sembastModule.db(get<_i12.PlatformInfo>()),
      preResolve: true);
  gh.factory<_i33.GenerateThumbnailJob>(
      () => _i33.GenerateThumbnailJobImpl(get<_i24.Thumbnailer>()));
  gh.singleton<_i34.NotificationManager>(
      _i34.NotificationManagerImpl(get<_i12.PlatformInfo>()));
  gh.factory<_i35.RefImageOptionsCubit>(
      () => _i35.RefImageOptionsCubit(get<_i26.AppSettings>()));
  gh.singleton<_i19.SaveRefImageJobController>(
      _i19.SaveRefImageJobController(get<_i18.SaveRefImageNativeService>()));
  gh.factory<_i36.SaveThumbnailJob>(
      () => _i36.SaveThumbnailJobImpl(get<_i23.ThumbnailFS>()));
  gh.factory<_i37.ShowcaseCubit>(
      () => _i37.ShowcaseCubit(get<_i26.AppSettings>()));
  gh.singleton<_i38.AppCubit>(_i38.AppCubit(get<_i26.AppSettings>()));
  gh.singleton<_i39.AppDatabase>(_i39.AppDatabaseImpl(get<_i32.Database>()));
  gh.factory<_i40.AppearanceSettingsCubit>(() => _i40.AppearanceSettingsCubit(
      get<_i26.AppSettings>(),
      get<_i38.AppCubit>(),
      get<_i41.ComparisonSettingsCubit>()));
  gh.factory<_i42.CrashReportManager>(() => _i42.CrashReportManagerImpl(
      get<_i30.CrashReportBuilder>(), get<_i31.CrashReportSender>()));
  ...
  gh.singleton<_i19.SaveRefImageService>(_i19.SaveRefImageServiceImpl(
      ...
      get<_i33.GenerateThumbnailJob>(),
      get<_i36.SaveThumbnailJob>()));
...
class _$SembastModule extends _i39.SembastModule {}
